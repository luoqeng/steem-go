...
type Config struct {
	...
	Percent100 int `json:"STEEM_100_PERCENT"`
	...
	BlockInterval uint `json:"STEEM_BLOCK_INTERVAL"`
	...
	ChainID string `json:"STEEM_CHAIN_ID"`
	...
	VoteRegenerationSeconds int `json:"STEEM_VOTING_MANA_REGENERATION_SECONDS"`
